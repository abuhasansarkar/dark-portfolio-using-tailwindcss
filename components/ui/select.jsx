...
const SelectTrigger = React.forwardRef(
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-10 w-full items-center justify-between rounded-md border border-accent/50 bg-primary outline-none px-3 py-2 text-sm focus:border-accent taxt-base placeholder:text-sm",
        className
      )}
      {...props}
    >
